    ...
    class ServicoDAO
    {
        ...
        public function carregaPorIdServico(int $id)
        {
            ...
            try {
                ...
                // Utilize fetch em vez de fetchAll
                ...
                if ($resul) {
                    ...
                    // Tratar caso não encontre nenhum resultado
                    return null;
                }
            } catch (\PDOException $e) {
        ...
        public function carregaPorIdServicoJson(int $id)
        {
            ...
            try {
                ...
                $servico = new Servico();
                $servico->setId($resul[0]['id']);
                $servico->setNome($resul[0]['nome']);
                $servico->setDescricao($resul[0]['descricao']);
