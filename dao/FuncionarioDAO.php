...
if (!class_exists('FuncionarioDAO')) {
    class FuncionarioDAO
    {
        ...
        {
            $sqlListarFuncionarios = "SELECT * FROM funcionarios WHERE perfil_id != 10";
        ...
        public function listarFuncionariosServicos()
        {
            $sqlListarFuncionarios = "SELECT funcionarios.* FROM funcionarios JOIN perfil ON funcionarios.perfil_id = perfil.id WHERE perfil.titulo = 'Fisioterapeuta';";
